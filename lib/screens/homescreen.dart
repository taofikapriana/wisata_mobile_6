...
import 'package:wisata_mobile_6/screens/detailscreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> pages = [
    HalamanPertama(),
    Center(child: Text('Halaman 2: Pencarian', style: TextStyle(fontSize: 24))),
    Center(child: Text('Halaman 3: Profil', style: TextStyle(fontSize: 24))),
  ];
